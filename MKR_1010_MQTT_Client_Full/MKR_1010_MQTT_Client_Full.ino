...
void loop() {
  ...
  Serial.print("ESP32CAMValue: ");
  Serial.println(esp32CamValue);

  Serial.print("MicroWaveSensorValue: ");
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (strcmp(topic, "microwaveSensorTopic") == 0) {
  // Strings are equal
      esp32CamValue = (char)payload[0];
  } else if(strcmp(topic, "esp32camTopic") == 0) {
  // Strings are equal
    microWaveSensorValue = (char)payload[0];
  }
